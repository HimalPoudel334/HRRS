...
namespace HRRS.Migrations
{
    ...
    [Migration("20250310024131_BedCountFacilityTypeMappings")]
    partial class BedCountFacilityTypeMappings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BedCountFacilityType", b =>
                {
                    b.Property<int>("BedCountsId")
                        .HasColumnType("int");

                    b.Property<int>("FacilityTypesSN")
                        .HasColumnType("int");

                    b.HasKey("BedCountsId", "FacilityTypesSN");

                    b.HasIndex("FacilityTypesSN");

                    b.ToTable("BedCountFacilityType");
                });
            ...
            modelBuilder.Entity("HRRS.Persistence.Entities.UserPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRRS.Persistence.Entities.UserRoleFacilityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserRoleFacilityType");
                });
            ...
            modelBuilder.Entity("BedCountFacilityType", b =>
                {
                    b.HasOne("HRRS.Persistence.Entities.BedCount", null)
                        .WithMany()
                        .HasForeignKey("BedCountsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HRRS.Persistence.Entities.User", b =>
                {
                    ...
                    b.HasOne("HRRS.Persistence.Entities.UserPost", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("HRRS.Persistence.Entities.UserRoleFacilityType", b =>
                {
                    ...
                    b.HasOne("HRRS.Persistence.Entities.Role", "Role")
                        .WithMany("UserRoleFacilityTypes")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HRRS.Persistence.Entities.Role", b =>
                {
                    b.Navigation("UserRoleFacilityTypes");
