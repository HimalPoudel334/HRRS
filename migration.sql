...
VALUES (N'20250215132742_InitialCreate', N'9.0.1');

ALTER TABLE [Mapdandas] ADD [Value100] nvarchar(max) NULL;

ALTER TABLE [Mapdandas] ADD [Value200] nvarchar(max) NULL;

ALTER TABLE [Mapdandas] ADD [Value25] nvarchar(max) NULL;

ALTER TABLE [Mapdandas] ADD [Value50] nvarchar(max) NULL;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250216051440_AddMapdandaCols', N'9.0.1');

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250216053721_AddedNewTable', N'9.0.1');

ALTER TABLE [HospitalStandardEntrys] ADD [SubmissionType] int NOT NULL DEFAULT 0;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250216073534_AddSubmissionTypeColInEntry', N'9.0.1');
